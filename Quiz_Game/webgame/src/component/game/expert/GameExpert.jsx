...
export default function GameExpert(){
    ...
    useEffect(()=>{
        ...
        Service.QuizGet("Expect").then(({data}) => {
            setData(data);
            console.log(data);
        });
    ...
    function updateScore(){
        var jsonOBJ = ({
            ...
            "fair": user.fair,
            "good": user.good,
            "expert": Number(sessionStorage.getItem("score"))
        });
        console.log(jsonOBJ);
        Service.ScoreUpdate(jsonOBJ)
        .then(({data})=>{
            console.log(data);
            window.location.replace("/gameexpert/over");
        }).catch(({response})=>{
    ...
    function answer(ans){
        ...
        if(Number(ans) == Number(aveData.correct)){
            ...
            window.location.replace("/gameexpert");
        }
        else
        {
            updateScore();
