...
export default function GameGood(){
    ...
    useEffect(()=>{
        ...
        Service.QuizGet("Good").then(({data}) => {
            setData(data);
            console.log(data);
        });
    ...
    function updateScore(){
        var jsonOBJ = ({
            ...
            "fair": user.fair,
            "good": Number(sessionStorage.getItem("score")),
            "expert": user.expert
        });
        console.log(jsonOBJ);
        ...
        .then(({data})=>{
            console.log(data);
            window.location.replace("/gamegood/over");
        }).catch(({response})=>{
    ...
    function answer(ans){
        ...
        if(Number(ans) == Number(aveData.correct)){
            ...
            window.location.replace("/gamegood");
        }
        else
        {
            updateScore();
